...
class Mage_Adminhtml_Block_Customer_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    public function __construct()
    {
        ...
        $this->setTitle(Mage::helper('customer')->__('Nfe Request Information'));
    }
...
*/
        ...
        $this->addTab('newsletter', array(
            ...
            'content'   => $this->getLayout()->createBlock('indexa_nfe/adminhtml_sales_order_edit_tab_info')->initForm()->toHtml()
        ));

        $this->_updateActiveTab();
        Varien_Profiler::stop('nfe/tabs');
