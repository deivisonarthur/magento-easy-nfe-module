...
class Indexa_Nfe_Block_Adminhtml_Sales_Order_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
...
class Indexa_Nfe_Block_Adminhtml_Sales_Order_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    ...
    public function getFormHtml()
    {
        ...
        $html .= $this->getLayout()->createBlock('indexa_nfe/adminhtml_sales_order_edit_form')->toHtml();
        return $html;
    }
