...
class Indexa_Nfe_Model_Resource_Sales_Order_Nf_Collection extends Indexa_Nfe_Model_Resource_Db_Collection_Abstract{
    ...
    public function _construct(){
        $this->_init('indexa_nfe/sales_order_nf');
    }
