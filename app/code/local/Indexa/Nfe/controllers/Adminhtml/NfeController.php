...
class Indexa_Nfe_Adminhtml_NfeController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function saveAction(){
        $this->_initRequest();
        $nfId = Mage::getModel('indexa_nfe/sales_order_request')->load( Mage::registry('nfe_data')->getId() )->getNfeNfId();
        $orderId = Mage::getModel('indexa_nfe/sales_order')->load( Mage::getModel('indexa_nfe/sales_order_nf')->load( $nfId )->getNfOrderId() )->getOrderId();
       ...
       if( Mage::getStoreConfig('indexa_nfe/config/tpamb') == '1' ){
            $url = Indexa_Nfe_Model_Nfe::NFE_REQUEST_PUT_URL;
        }else{
            $url = Indexa_Nfe_Model_Nfe::NFE_TEST_REQUEST_PUT_URL;
        }
    ...
    public function xmlAction(){
        ...
        $file_name = Mage::getBaseDir() . '/nf/xml/'.$key.'.xml';
    ...
    public function pdfAction(){
        ...
        $file_name = Mage::getBaseDir() . '/nf/pdf/'.$key.'.pdf';
